...
label_values = ["Clay (FT-01)", "Tufa grains (FT-02)", "Calcareous silt (FT-03)", "Tufa & reed (FT-04)", "Silt & moss (FT-05)", "Silt & organic debris (FT-06)",
    "Brown peat (FT-07)", "Black peat (FT-08)"]
